...
update tasks
set "from" = to_timestamp(concat(tasks.date, ' ', tasks.time), 'YYYY-MM-DD HH24:MI:SS');

-- 161 форма: добавляем 1 месяц к дате
update tasks
set "to" = "from" + interval '1' month
...
update tasks
set "to" = "from" + interval '1 month' + interval '7 day'
